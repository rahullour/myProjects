       ...
       // //System.out.println("==================="+loadingDialog.isCancelled());
        ...
        executorServiceBrowseBookName.execute(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    String login_url = "https://rahullour.thats.im/get_browse_book_name.php";
                    ...
                    public void run() {
                        ...
                        executorServiceBrowseAuthor.execute(new Runnable() {
                            ...
                            public void run() {
                                ...
                                try {
                                    String login_url = "https://rahullour.thats.im/get_browse_author.php";
                                    //System.out.println("running-----------------------------------------------------------------------");
                                    ...
                                    public void run() {
                                        ...
                                        executorServiceBrowsePublisher.execute(new Runnable() {
                                            ...
                                            public void run() {
                                                ...
                                                try {
                                                    String login_url = "https://rahullour.thats.im/get_browse_publisher.php";
                                                    //System.out.println("running-----------------------------------------------------------------------");
                                                    ...
                                                    public void run() {
                                                        ...
                                                        executorServiceBrowseCourse.execute(new Runnable() {
                                                            ...
                                                            public void run() {
                                                                ...
                                                                try {
                                                                    String login_url = "https://rahullour.thats.im/get_browse_course.php";
                                                                    //System.out.println("running-----------------------------------------------------------------------");
                                                                    ...
                                                                    public void run() {
                                                                        ...
                                                                        executorServiceBrowseYop.execute(new Runnable() {
                                                                            ...
                                                                            public void run() {
                                                                                ...
                                                                                try {
                                                                                    String login_url = "https://rahullour.thats.im/get_browse_yop.php";
                                                                                    //System.out.println("running-----------------------------------------------------------------------");
                                                                                    ...
                                                                                    public void run() {
                                                                                        ...
                                                                                        executorServiceBrowsePendingBookName.execute(new Runnable() {
                                                                                            ...
                                                                                            public void run() {
                                                                                                ...
                                                                                                try {
                                                                                                    String login_url = "https://rahullour.thats.im/get_pending_book_name.php";
                                                                                                    //System.out.println("running-----------------------------------------------------------------------");
                                                                                                    ...
                                                                                                    public void run() {
                                                                                                        ...
                                                                                                        executorServiceBrowseAvailableCount.execute(new Runnable() {
                                                                                                            ...
                                                                                                            public void run() {
                                                                                                                ...
                                                                                                                try {
                                                                                                                    String login_url = "https://rahullour.thats.im/get_browse_available_count.php";
                                                                                                                    //System.out.println("running-----------------------------------------------------------------------");
                                                                                                                    ...
                                                                                                                    public void run() {
                                                                                                                        ...
                                                                                                                        executorServiceBrowseGetButtonBookName.execute(new Runnable() {
                                                                                                                            ...
                                                                                                                            public void run() {
                                                                                                                                ...
                                                                                                                                try {
                                                                                                                                    String login_url = "https://rahullour.thats.im/get_browse_get_button_book_name.php";
                                                                                                                                    //System.out.println("running-----------------------------------------------------------------------");
                                                                                                                                    ...
                                                                                                                                    public void run() {
                                                                                                                                        ...
                                                                                                                                        executorServiceBrowseImages.execute(new Runnable() {
                                                                                                                                            ...
                                                                                                                                            public void run() {
                                                                                                                                                ...
                                                                                                                                                try {
                                                                                                                                                    String login_url = "https://rahullour.thats.im/get_browse_book_images.php";
                                                                                                                                                    //System.out.println("running-----------------------------------------------------------------------");
