...
public class Globals {
    ...
    public static  String[]  spinner_my_book_name=new String[50];
    public static  String[]  spinner_my_book_borrow_date=new String[50];
    public static  String[]  spinner_my_book_return_date=new String[50];
    public static  String[]  spinner_my_book_late_fee=new String[50];
    public static  String[]  spinner_my_book_yop=new String[50];
    public static  String[]  spinner_my_book_available_count=new String[50];
    public static  String[]  spinner_my_book_image=new String[50];
    public static  String[] spinner_my_book_course =new String[50];
