...
public class LateFeeFragment extends Fragment implements AdapterView.OnItemSelectedListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        executorServiceStudentLateFee.execute(new Runnable() {
            ...
            public void run() {
                try {
                    String login_url = "https://rahullour.thats.im/get_late_fee_student_late_fee.php";
                    //System.out.println("running-----------------------------------------------------------------------");
                ...
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        executorServiceStudentId.execute(new Runnable() {
                            ...
                            public void run() {
                                try {
                                    String login_url = "https://rahullour.thats.im/get_late_fee_student_id.php";
                                    //System.out.println("running-----------------------------------------------------------------------");
                                ...
                                getActivity().runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        executorServiceStudentCourse.execute(new Runnable() {
                                            ...
                                            public void run() {
                                                try {
                                                    String login_url = "https://rahullour.thats.im/get_late_fee_student_course.php";
                                                    //System.out.println("running-----------------------------------------------------------------------");
                                                ...
                                                getActivity().runOnUiThread(new Runnable() {
                                                    ...
                                                    public void run() {
                                                        ...
                                                        executorServiceStudentName.execute(new Runnable() {
                                                            ...
                                                            public void run() {
                                                                try {
                                                                    String login_url = "https://rahullour.thats.im/get_late_fee_student_name.php";
                                                                    //System.out.println("running-----------------------------------------------------------------------");
                                                                ...
                                                                getActivity().runOnUiThread(new Runnable() {
                                                                    ...
                                                                    public void run() {
                                                                        ...
                                                                        executorServiceStudentBookCount.execute(new Runnable() {
                                                                            ...
                                                                            public void run() {
                                                                                try {
                                                                                    String login_url = "https://rahullour.thats.im/get_late_fee_student_book_count.php";
                                                                                    //System.out.println("running-----------------------------------------------------------------------");
