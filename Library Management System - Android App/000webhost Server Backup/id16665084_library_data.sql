...
--
-- Database: `id16665084_library_data`
--
...
INSERT INTO `admin` (`id`, `email`, `pwd`, `otp`, `name`) VALUES
('06914902018', 'rahulbidawas@gmail.com', '123456789', '', 'Rahul Lour');
...
('Brief Answers To Big Questions', 'Stephen Hawking', 'JM publishers', 2018, 'BSC', 2, 2),
...
('Multimedia- Making It Work', 'Tay Vaughan', 'McGraw Hill', 2014, 'B.TECH', 15, 15),
...
('The Soul Of A New Machine', 'Tracy Kidder', 'Little, Brown and company', 1981, 'BCA', 3, 3);
...
('shivam', '07714902018', 'poplu@123', 'shivam@gmail.com', NULL, NULL, 'BCA');
