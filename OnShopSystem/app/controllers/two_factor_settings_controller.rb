class TwoFactorSettingsController < ApplicationController
  ...
  def create
    unless current_user.valid_password?(enable_2fa_params[:password])
      ...
      redirect_to new_two_factor_settings_path and return
    end
    if current_user.validate_and_consume_otp!(enable_2fa_params[:code])
      ...
      redirect_to edit_two_factor_settings_path and return
    else
  ...
  def enable_2fa_params
    params.require(:two_fa).permit(:telephone, :code, :password)
  end
